...
OUTPUT_FILE = RESULTS_DIR / "credit_g_leaf_expansion_same_metric_summary.json"
...
def build_summary() -> dict[str, Any]:
    ...
    return {
        "protocol_name": "credit_g_leaf_expansion_same_metric_v1",
        "dataset": "credit-g",
        "generated_at_utc": datetime.now(timezone.utc).isoformat(),
        "metric_scope": "same_test_accuracy_eval",
        "strict_same_metric_protocol_ready": False,
        "notes": [
            "这份摘要聚焦 credit-g 上 leaf expansion 原型第一轮结果。",
...
def main() -> None:
    ...
    print(f"Wrote credit-g same-metric summary to {OUTPUT_FILE}")
