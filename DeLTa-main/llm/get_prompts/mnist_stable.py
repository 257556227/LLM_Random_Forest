...
The number of leaf nodes should no more than 20.
Please return ONLY one Python code block and no extra explanation.
The format should be strictly like:
...
Each internal node must contain both "left" and "right" fields.
