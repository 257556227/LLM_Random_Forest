...
class TestCarIntegration(unittest.TestCase):
    ...
    def test_car_data_and_artifacts_exist(self):
        dataset_dir = self.delta_root / "example_datasets" / "car"
        results_dir = self.delta_root / "results" / "car"
        readiness_file = results_dir / "car_integration_readiness.json"
        ...
        same_metric_file = results_dir / "car_leaf_expansion_same_metric_summary.json"
        formal_protocol_file = results_dir / "car_leaf_expansion_formal_protocol_summary.json"
